...
class FileUtils {
    ...
    companion object {
        ...
        val appLogPath = BaseApplication.getContext().getExternalFilesDir(null)?.absolutePath +
                File.separator + "log" + File.separator + "app" + File.separator
        ...
        /**
         * 外置存储卡文件路径
         * /storage/emulated/0/Android/data/com.bytebitx.wanandroid/files
         */
        @JvmStatic
        ...
        /**
         * 外置存储卡缓存的路径
         * /storage/emulated/0/Android/data/com.bytebitx.wanandroid/cache
         */
        ...
        /**
         * 内置存储卡文件的路径
         * /data/user/0/com.bytebitx.wanandroid/files
         */
        ...
        /**
         * 内置存储卡缓存的路径
         * /data/user/0/com.bytebitx.wanandroid/cache
         */
