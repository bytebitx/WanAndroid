package com.bytebitx.base.util.statusbar.impl;
...
import com.bytebitx.base.util.statusbar.INotchScreen;
import com.bytebitx.base.util.statusbar.utils.ScreenUtil;
...
public class OppoNotchScreen implements INotchScreen {
    ...
    @Override
    public void getNotchRect(Activity activity, INotchScreen.NotchSizeCallback callback) {
        try {
